    ...
    Logger
        ...
        var util = new Util(),
            ...
            match: function (name, pointcutOrPlugin) {
                ...
                matchstr = (pointcutOrPlugin && (pointcutOrPlugin.pointcut || pointcutOrPlugin.pattern))
                    || pointcutOrPlugin;
    
                if ((pointcutOrPlugin && pointcutOrPlugin.pointcut)
                        || typeof (pointcutOrPlugin) === 'string') {
            ...
            getPhaseChains: function (serviceName, methodName, factoryPlugins, servicePlugins, invokePlugins) {
                ...
                Object.keys(ret).forEach(function (key, idx, obj) {
